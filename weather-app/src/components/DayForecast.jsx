    ...
    return (
        <>
            <button
                ...
                className={`${className} mx-2 my-2 w-full  hover:border hover:border-gray-900 hover:bg-blue-100 rounded-lg shadow-md p-3 flex flex-col items-center justify-center transition duration-300 transform hover:scale-101`}
                disabled={disabled}
                {...disabled ? { 'className': "cursor-default blur mx-2 my-2 w-full bg-gray-800 rounded-lg shadow-md p-3 flex flex-col items-center justify-center disabled-button" }: {}}
            >
