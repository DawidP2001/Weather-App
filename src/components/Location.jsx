...
export default function Location({ weather, current, location, selectedDay }) {
    const currentWeather = <>
        ...
        <div className="mt-2 text-center text-2xl font-semibold">{current.temp_c}°C</div>
        <div className="grid grid-cols-2 gap-y-1 text-sm p-4">
            <div className="font-medium text-right">Feels Like:</div>
            <div className="text-left pl-4">{current.feelslike_c}</div>
            ...
            <div className="text-left pl-4">{current.wind_kph}kph {current.wind_dir}</div>
            ...
            <div className="text-left pl-4">{current.vis_km}km</div>
